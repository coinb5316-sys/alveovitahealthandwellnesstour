...
import { 
  ...
  Loader2, X, Shield, Lock, Heart, Gift,
  Coffee, Sun, Moon, Cloud, Wind, Droplets,
  TreePine, Mountain, Compass, Camera,
  Music, Palette, Wand2, Layers, Grid
} from 'lucide-react'
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-green-500">Online • Usually replies instantly</p>
                  </div>
                </div>
                <button
              ...
              <div className="h-96 p-4 overflow-y-auto">
                <div className="flex flex-col gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-xl rounded-tl-none max-w-[80%]">
                      <p className="text-sm text-gray-800 dark:text-gray-200">
                        Hello! Welcome to Alveovita. How can I help you today?
                      </p>
                      <span className="text-[10px] text-gray-500 mt-1">Just now</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 justify-end">
                    <div className="bg-amber-500 text-white p-3 rounded-xl rounded-tr-none max-w-[80%]">
                      <p className="text-sm">
                        Hi, I'd like to know more about your wellness retreats.
                      </p>
                      <span className="text-[10px] text-amber-100 mt-1">Just now</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center flex-shrink-0">
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-xl bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:border-amber-500 outline-none text-sm text-gray-900 dark:text-white placeholder-gray-500"
                  />
                  <button className="p-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-white hover:scale-105 transition-all">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-6 md:mt-8">
              <button 
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full font-medium hover:shadow-lg hover:shadow-amber-500/30 transition-all hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
              >
              ...
              <button 
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 border-2 border-white/30 text-white rounded-full font-medium hover:bg-white/10 transition-all backdrop-blur-sm hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
              >
      ...
      <section id="contact-form" className="py-12 sm:py-16 md:py-20">
        <div className="container-custom px-4 sm:px-6">
          <div className="grid lg:grid-cols-5 gap-6 md:gap-8 lg:gap-12">
              ...
              <div className={`p-5 sm:p-6 md:p-8 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-2xl`}>
                ...
                {submitted ? (
                  <motion.div
                    ...
                    className={`p-5 sm:p-6 rounded-2xl ${isDark ? 'bg-green-900/30' : 'bg-green-50'} border border-green-500/30`}
                  >
                    <div className="flex items-center gap-3">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-4 py-2.5 sm:py-3 rounded-xl outline-none ${
                              isDark 
                                ? 'bg-gray-700 text-white border-gray-600' 
                                : 'bg-gray-50 text-gray-800 border-gray-200'
                            } border focus:border-amber-500 transition-colors text-sm sm:text-base`}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className={`w-full px-4 py-2.5 sm:py-3 rounded-xl outline-none ${
                          isDark 
                            ? 'bg-gray-700 text-white border-gray-600' 
                            : 'bg-gray-50 text-gray-800 border-gray-200'
                        } border focus:border-amber-500 transition-colors resize-none text-sm sm:text-base`}
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-medium hover:scale-105 transition-all shadow-lg shadow-amber-500/30 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
                    >
                      {loading ? (
                        <>
            ...
            >
              {/* Map */}
              <div className={`p-5 sm:p-6 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-xl`}>
              ...
              {/* Quick Response */}
              <div className={`p-5 sm:p-6 rounded-2xl ${isDark ? 'bg-gradient-to-r from-amber-900/30 to-orange-900/30' : 'bg-gradient-to-r from-amber-50 to-orange-50'} border border-amber-500/20`}>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <button 
                      onClick={() => setShowChat(true)}
                      className="mt-2 sm:mt-3 px-4 sm:px-6 py-1.5 sm:py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-medium hover:scale-105 transition-all flex items-center gap-2 text-sm"
                    >
                      <MessageSquare className="w-4 h-4" />
                      Start Live Chat
                    </button>
        ...
        <div className="container-custom px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto space-y-3 sm:space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className={`mt-1 sm:mt-2 text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      {faq.answer}
                    </p>
                  </div>
                </div>
        ...
        <div className="container-custom relative z-10 px-4 sm:px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-4 sm:mb-6 border border-white/20">
              ...
              <span className="text-xs sm:text-sm font-medium">Book Your Consultation Today</span>
            </div>
